...
import {
  getTotalFeedCostsData,
  getTotalFeedCostsAvailableYears,
...
export default function TotalFeedCostsChart({ customerId }: Props) {
  ...
  useEffect(() => {
    getTotalFeedCostsAvailableYears().then((res) => {
    ...
    <div>
      ...
      <Plot
        ...
        layout={{
          ...
          yaxis: { title: { text: "Total Feed Costs ($/CWT)" } },
          autosize: true,
        }}
