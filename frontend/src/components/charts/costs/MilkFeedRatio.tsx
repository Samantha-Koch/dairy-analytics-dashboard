...
import {
  getMilkFeedRatioData,
  getMilkFeedRatioAvailableYears,
...
export default function MilkFeedRatioChart({ customerId }: Props) {
  ...
  useEffect(() => {
    getMilkFeedRatioAvailableYears().then((res) => {
    ...
    <div>
      ...
      <Plot
        ...
        layout={{
          ...
          yaxis: { title: { text: "Milk-Feed Ratio" } },
          autosize: true,
        }}
