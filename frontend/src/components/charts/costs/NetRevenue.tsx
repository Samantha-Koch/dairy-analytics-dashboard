...
export default function NetRevenueChart({ customerId }: Props) {
  ...
  useEffect(() => {
    getNetRevenueAvailableYears().then((res) => {
    ...
    <div>
      ...
      <Plot
        ...
        layout={{
          ...
          yaxis: { title: { text: "Net Revenue ($/CWT)" } },
          autosize: true,
        }}
