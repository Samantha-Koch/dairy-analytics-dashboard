...
export default function MarginCowChart({ customerId }: Props) {
  ...
  useEffect(() => {
    getMarginPerCowAvailableYears().then((res) => {
    ...
    <div>
      ...
      <Plot
        ...
        layout={{
          ...
          yaxis: { title: { text: "Margin per Cow ($/Cow)" } },
          autosize: true,
        }}
